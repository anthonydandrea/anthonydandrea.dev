  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {Senior Software Engineer}{Mar 2025 \textbf{--} Present}
        \resumeItemListStart
            \resumeItem{Technical lead for Facebook Sharesheet (\textbf{2B opens/day}); drove \textbf{3-engineer workstream} delivering \textbf{$+$2M shares}, \textbf{50\% faster loads}, and \textbf{99.9\% fewer failures} while aligning product, data science, and UXR.}
            \resumeItem{Bootstrapped Android architecture for Messenger People Tab (\textbf{6.3M DAU}); built UI and data lifecycle patterns enabling team to ship features fast.}
            \resumeItem{Leading removal of all unused feature flags from Facebook and Messenger, enforcing as a build failure; projected \textbf{$\sim$\$200k/year} capacity savings.}
            \resumeItem{Built cross-platform reporting and notifications infrastructure for Messenger Moments launch (Android, iOS, server); required for safety compliance and user adoption.}
            \resumeItem{Leading Messenger live location feature for peer-to-peer sharing; aligning E2EE architecture and legal to deliver a privacy-first live location experience.}
        \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      {Software Development Engineer}{Feb 2021 \textbf{--} Feb 2025}
        \resumeItemListStart
            \resumeItem{Architected zero-to-one \textbf{Rust} cross-platform build tool; became org standard for \textbf{Fire TV} (\textbf{200$+$ engineers}, \textbf{70$+$ packages}) with rollout expanding to additional Amazon orgs.}
            \resumeItem{Built heartbeat processing service (\textbf{8.1M heartbeats/min}) and metrics ingestion service (\textbf{3B metrics/day}) powering billing and observability for \href{https://docs.aws.amazon.com/guardduty/latest/ug/runtime-monitoring.html}{GuardDuty Runtime Monitoring}'s \textbf{global GA launch}, announced at \textbf{re:Invent 2022}.}
            ...
            \resumeItem{Designed and built org-wide data catalog adopted across all of GuardDuty engineering and research, scaling to \textbf{157 datasets} across \textbf{40$+$ engineers} and \textbf{6$+$ teams}.}
        \resumeItemListEnd
