...
\section{Technical Skills}
  ...
  \resumeSubHeadingListStart
    \small{\item{
        ...
        \textbf{Areas of Expertise:}{ Cloud infrastructure (AWS), Distributed systems, Developer tooling,  Android platform engineering, Cross-platform development,  CI/CD \& build systems} \\ \vspace{3pt}
